...
import { Box, Button, Checkbox, Dialog, DialogActions, DialogContent, DialogTitle, List, ListItem, ListItemIcon, ListItemText, MenuItem, Select, Tab, Tabs, TextField, Typography } from '@mui/material';
...
interface NoteSaveDialogProps {
    open: boolean;
    onClose: () => void;
    saveWithTags: (tagIds: number[]) => void;
}
...
const NoteSaveDialog: React.FC<NoteSaveDialogProps> = ({ open, onClose, saveWithTags }) => {
    ...
    // const handleSubmit = () => {
    //     // Send selectedTags to the backend
    //     console.log('Selected tags:', selectedTags);
    //     saveWithTags(selectedTags);
    //     onClose();
    // };

...
const Chat: React.FC<ChatProps> = ({ authProps, appState, setAppState, onNewDiscussion }) => {
  ...
  return appState ? (
    ...
    >
      <NoteSaveDialog
        authProps={authProps}
        open={isNoteSaveDialogOpen}
        saveWithTag={saveNoteWithTags}
        onClose={() => {
          handleNoteSaveDialogClose();
        }}
      ></NoteSaveDialog>
      ...
      {discussionId != null && actionMessageId != null && (
        <FlashCardSaveWizard
          authProps={authProps}
          open={isFlashcardSaveDialogOpen}
          discussionId={discussionId}
          messageId={actionMessageId}
          setOpen={setIsFlashcardSaveDialogOpen}
        ></FlashCardSaveWizard>
      )}
      <CssBaseline />
      <Box
      ...
      >
        ...
        >
          ...
          >
            ...
            {isThinking && <LinearProgress sx={{ marginTop: 2 }} />}
          </Box>
